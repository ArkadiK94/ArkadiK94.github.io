...
function form(formSelector, modalWindow, modalSelector, openModal) {
  ...
  formInPage.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      divMassege.src = message.loading;
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_9__.postData)('http://localhost:3000/requests', json).then(function (data) {
        showModalAnswer(message.success);
        console.log(data);
        divMassege.remove();
      }).catch(function () {
        showModalAnswer(message.failure);
      }).finally(function () {
        item.reset();
      });
    });
  ...
  function showModalAnswer(message) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-12-10T00:00');
